...
public class Access {
        ...
        public static Stream<Arguments> argsProviderFactory()
                ...
                Scenario test = new Scenario("1|(0,0)|()|0|50|1" + System.lineSeparator() + "2|(0,0)|()|0|50|2"
                                ...
                                + "3|(0,0)|((2,),)|0|50|3" + System.lineSeparator() + "4|(0,0)|((3,),)|0|50|4"
                                + System.lineSeparator()
                                + "0|(0,0)|((4,),)|0|100|0");
                return Stream.of(
                                Arguments.of(new Vector<>(Arrays.asList(test.getQuest(1), test.getQuest(2))),
                                                test.getQuest(3), true),
                                Arguments.of(new Vector<>(Arrays.asList(test.getQuest(1), test.getQuest(2))),
                                                test.getQuest(4), false),
                                Arguments.of(new Vector<>(), test.getQuest(1), true),
                                Arguments.of(
                                                new Vector<>(
                                                                Arrays.asList(test.getQuest(1), test.getQuest(2),
                                                                                test.getQuest(3), test.getQuest(4))),
                                ...
                                Arguments.of(new Vector<>(
                                                Arrays.asList(test.getQuest(1), test.getQuest(2), test.getQuest(3))),
